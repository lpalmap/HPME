                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <button class="btn btn-success" id="btnAgregar"><i class="icon-plus icon-white" ></i> Agregar Rol</button>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTableItems">
                                    ...
                                    <tbody id="lista-items" name="lista-items">
                                        ...
                                        <tr class="even gradeA" id="item{{$items[$i]->ide_rol}}">
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-editar" value="{{$items[$i]->ide_rol}}"><i class="icon-pencil icon-white" ></i> Editar</button>
                                                <button class="btn btn-danger" value="{{$items[$i]->ide_rol}}"><i class="icon-remove icon-white"></i> Eliminar</button>
                                            </td>
                                        </tr>
                                            @endfor
                                        @endif
...
@section('footer')
    @parent
        ...
        <script src="{{asset('js/hpme.roles.js')}}"></script>
@endsection