                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         <div class="panel-body">
                             <button class="btn btn-success" id="btnMonitoreo" title="Iniciar el proceso de monitoreo del proyecto"><i class="icon-plus icon-white" ></i>Iniciar Monitoreo</button>
