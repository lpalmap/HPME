                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            &nbsp;
                            &nbsp;
                            <a href="{{url('plandetalleexport/'.$ideProyectoRegion)}}" >
                                <img src="{{asset('images/excel.png')}}" class="menu-imagen-big" alt="" title="Exportar planificaci&oacute;n a Excel(No se incluye productos con planificaci&oacute;n 0)"/></a>
