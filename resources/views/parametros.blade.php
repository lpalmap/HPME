                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <button class="btn btn-success" id="btnAgregar"><i class="icon-plus icon-white" ></i> Agregar Par&aacute;metro</button>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTableItems">
                                    ...
                                    <tbody id="lista-items" name="lista-items">
                                        ...
                                        <tr class="even gradeA" id="item{{$items[$i]->ide_parametro}}">
                                            <td>{{$items[$i]->nombre}}</td>
                                            <td>{{$items[$i]->valor}}</td>
                                            <td>{{$items[$i]->descripcion}}</td>
                                            <td>
                                                <button class="btn btn-primary btn-editar" value="{{$items[$i]->ide_parametro}}"><i class="icon-pencil icon-white" ></i> Editar</button>
                                                <button class="btn btn-danger" value="{{$items[$i]->ide_parametro}}"><i class="icon-remove icon-white"></i> Eliminar</button>
                                            </td>
                                        </tr>
                                            @endfor
                                        @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="H1">Eliminar Par&aacute;metro</h4>
                                        </div>
                                        <div class="modal-body">
                                            Esta seguro de eliminar el par&aacute;metro.
                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                       ...
                                       <form role="form" id="formAgregar">
                                           ...
                                           <div class="form-group">
                                                <label>Valor</label>
                                                <input class="form-control" id="inValor" required="true"/>
                                           </div>
                                            <div class="form-group">
...
@section('footer')
    @parent
        ...
        <script src="{{asset('js/hpme.parametros.js')}}"></script>
@endsection