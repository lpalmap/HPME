                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <button class="btn btn-success" id="btnAgregar"><i class="icon-plus icon-white" ></i> Agregar Recurso</button>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTableItems">
                                    ...
                                    <tbody id="lista-items" name="lista-items">
                                        ...
                                        <tr class="even gradeA" id="item{{$items[$i]->ide_recurso}}">
                                            <td>{{$items[$i]->nombre}}</td>
                                            <td>{{$items[$i]->descripcion}}</td>
                                            <td>
                                                <button class="btn btn-primary btn-editar" value="{{$items[$i]->ide_recurso}}"><i class="icon-pencil icon-white" ></i> Editar</button>
                                                <button class="btn btn-danger" value="{{$items[$i]->ide_recurso}}"><i class="icon-remove icon-white"></i> Eliminar</button>
                                            </td>
                                        </tr>
                                            @endfor
                                        @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="H1">Eliminar Recurso</h4>
                                        </div>
...
@section('footer')
    @parent
        ...
        <script src="{{asset('js/hpme.recursos.js')}}"></script>
@endsection