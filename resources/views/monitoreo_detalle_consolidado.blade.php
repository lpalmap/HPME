...
<!--                                                <button class="btn btn-success" id="btnAgregar"><i class="icon-plus icon-white" ></i> Ver consolidado</button>-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            &nbsp;
                            &nbsp;
                            <a href="{{url('monconsolidadoexport/'.$ideProyecto)}}" >
                                <img src="{{asset('images/excel.png')}}" class="menu-imagen-big" alt="" title="Exportar monitoreo consolidada a Excel(No se incluye productos con planificaci&oacute;n 0)"/></a>                                
                        </div>
                                                        ...
                                                        <tr class="info {{$total>0?'':'goodbye'}}" style="text-align: center" >
                                                            ...
                                                            ?>
                                                               <td style="text-align: right;background: #BDD7EE;">{{number_format(intval($detalle->valor))}}</td>
                                                                <td style="text-align: right;background: #BDD7EE;">{{number_format(intval($detalle->ejecutado))}}</td>
                                                            <?php
                                                                }
                                                            ?>
                                                           <td style="text-align: right;background: greenyellow;">{{number_format($total)}}</td>
                                                            <td style="text-align: right;background: greenyellow;">{{number_format($totalEje)}}</td>
                                                        </tr>
                                                    <?php
                                                                }}}
                                                    ?>
