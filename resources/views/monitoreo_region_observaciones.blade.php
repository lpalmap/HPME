...
<!--PAGE CONTENT -->
        <div id="content">
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Observaciones Monitoreo <span style="font-weight: bolder;">{{$nombreProyecto}}/{{$nombreRegion}}</span></h2>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <a href="{{url('periodoregion/'.$idePeriodoRegion)}}" >
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span style="font-weight: bold">
                                @if($estado!='APROBADO')
                                <button id="btnAgregar" value="{{$idePeriodoRegion}}">
...
<!--        <script src="assets/plugins/dataTables/jquery.dataTables.js"></script>
        ...
        <script src="{{asset('js/hpme.monitoreo.observaciones.js')}}"></script>
@endsection