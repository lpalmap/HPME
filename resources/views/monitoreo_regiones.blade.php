                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body">
                             ...
                             <a href="{{url('planconsolidado/'.$ideProyecto)}}" >
                                ...
                                <img src="{{asset('images/plan_cerrar.png')}}" class="menu-imagen-big" value="{{$ideProyecto}}" title="Cerrar Periodo Monitoreo"/></button>
                                @endif
                                &nbsp;
                                &nbsp;
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTableItems">
                                    ...
                                    <tbody id="lista-items" name="lista-items">
                                        ...
                                        @endif
                                                ...
                                                <td><a href="{{asset('periodoregion/'.($regiones[$i]->ide_periodo_region))}}" >
