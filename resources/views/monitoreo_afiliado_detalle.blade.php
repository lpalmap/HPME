                                                ...
                                                <tr class="success" style="text-align: center" >
                                                    ...
                                                    ?>
                                                        <tr class="info {{$total>0?'':'goodbye'}}" style="text-align: center" >
                                                            ...
                                                            <td style="text-align: right;background: #f4c37d">{{$total}}</td>
                                                            <td>
...
<div class="modal fade" id="ingresarDetalleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="2" style="text-align: center">Ene-Mar</th>
                                            <th colspan="2" style="text-align: center">Abr-Jun</th>
                                            <th colspan="2" style="text-align: center">Jul-Sep</th>
                                            <th colspan="2" style="text-align: center">Oct-Dic</th>
                                    ...
                                    <tbody id="lista-items2" name="lista-items">                                      
                                        <tr class="even gradeA">
                                            ...
                                            <td>
                                                <input maxlength="7" disabled="true" tabindex="2" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="segundoTrim"  value="85"/>
                                            </td>
                                            <td>
                                                <input maxlength="7" tabindex="1" autofocus="true" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="primerTrim" value="" />  
                                            </td>
                                            <td>
                                                <input maxlength="7" disabled="true" tabindex="3" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="tercerTrim" value="200"/>
                                            </td>
                                            <td>
                                                <input maxlength="7" tabindex="1" autofocus="true" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="primerTrim" value="" />  
                                            </td>
                                            <td>
                                                <input maxlength="7" disabled="true" tabindex="4" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="cuartoTrim" value="125"/>
                                            </td>
                                            <td>
                                                <input maxlength="7" tabindex="1" autofocus="true" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="primerTrim" value="" />  
                                            </td>
                                            <td>
                                                <input align="right" disabled="true" class="form-control" disabled="true"  value="455" id="totalInput"/>
                                            </td>
                                            <td>
                                                <input maxlength="7" tabindex="1" autofocus="true" align="right" class="form-control TabOnEnter" type="text" data-mask="999999" id="primerTrim" value="" />  
                                            </td>
