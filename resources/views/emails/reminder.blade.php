...
.fblike {
  background-image: url(https://i6.createsend1.com/static/eb/master/13-the-blueprint-3/images/fblike.png);
}
.tweet {
  background-image: url(https://i8.createsend1.com/static/eb/master/13-the-blueprint-3/images/tweet.png);
}
.linkedinshare {
  background-image: url(https://i9.createsend1.com/static/eb/master/13-the-blueprint-3/images/lishare.png);
}
.forwardtoafriend {
  background-image: url(https://i10.createsend1.com/static/eb/master/13-the-blueprint-3/images/forward.png);
}
.email-footer .column {
  font-size: 12px;
  line-height: 19px;
...
<!--<![endif]-->
    <table class="wrapper" cellpadding="0" cellspacing="0" role="presentation"><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" align="center" style="Margin-top:20px;Margin-bottom:21px;">
            <div align="center" id="emb-email-header" class="logo-center"><img src="https://www.habitatguate.org/web/wp-content/uploads/2013/11/loghab.png" alt="" width="283" style="max-width:283px"></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
  ...
  <script type="text/javascript" src="https://js.createsend1.com/js/jquery-1.7.2.min.js?h=C99A4659201701110936"></script><script type="text/javascript">$(function(){$('area,a').attr('target', '_blank');});</script></body>
</html>