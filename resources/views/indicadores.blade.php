                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTableItems">
                                    ...
                                    <tbody id="lista-items" name="lista-items">
                                        ...
                                        <tr class="even gradeA" id="item{{$items[$i]->ide_indicador}}">
                                            <td>{{$items[$i]->nombre}}</td>
                                            <td>{{$items[$i]->descripcion}}</td>
                                            <td>{{$items[$i]->orden}}</td>
                                            <td>
                                                <button class="btn btn-primary btn-editar" value="{{$items[$i]->ide_indicador}}"><i class="icon-pencil icon-white" ></i> Editar</button>
                                                <button class="btn btn-danger" value="{{$items[$i]->ide_indicador}}"><i class="icon-remove icon-white"></i> Eliminar</button>
                                            </td>
                                        </tr>
                                            @endfor
                                        @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Esta seguro de eliminar el indicador.
                                        </div>
...
@section('footer')
    @parent
        ...
        <script src="{{asset('js/hpme.indicadores.js')}}"></script>
@endsection