...
class HPMEConstants
{
    ...
    const PLN_PRESUPUESTO_POR_DEPARTAMENTO_USUARIO="SELECT p.ide_presupuesto_departamento,d.nombre,p.fecha_ingreso,p.fecha_aprobacion,p.estado FROM pln_presupuesto_departamento p,cfg_departamento d WHERE p.ide_departamento=d.ide_departamento AND p.ide_proyecto_presupuesto=:ideProyectoPresupuesto AND d.ide_usuario_director=:ideUsuario";
