...
class HPMEConstants
{
    ...
    const PLN_REGION_PRODUCTO="SELECT r.ide_region_producto,p.nombre,r.descripcion FROM pln_region_producto r,cfg_proyecto p WHERE r.ide_proyecto=p.ide_proyecto AND r.ide_proyecto_region=:ideProyectoRegion AND r.ide_producto_indicador=:ideProductoIndicador ";
    
    const PLN_DETALLE_POR_PRODUCTO_REGION="SELECT d.num_detalle,d.valor FROM pln_region_producto r,pln_region_producto_detalle d WHERE d.ide_region_producto=r.ide_region_producto and r.ide_producto_indicador=:ideProductoIndicador and r.ide_proyecto_region=:ideProyectoRegion GROUP BY d.num_detalle";
    const SI='S';
    const NO='N';
