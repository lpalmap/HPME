...
$(document).ready(function(){
    ...
    $('#btnAgregar').click(function(){
        $('#inputTitle').html("Agregar Par&aacute;metro");
    ...
    $("#btnGuardar").click(function (e) {      
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data); 
                var item = '<tr class="even gradeA" id="item'+data.ide_parametro+'">'
                    item+='<td>'+data.nombre+'</td>'
                    item+='<td>'+data.valor+'</td>';
                    item+='<td>'+data.descripcion+'</td>';
                    item+='<td><button class="btn btn-primary btn-editar" value="'+data.ide_parametro+'"><i class="icon-pencil icon-white" ></i> Editar</button>';
                    item+='<button class="btn btn-danger" value="'+data.ide_parametro+'"><i class="icon-remove icon-white"></i> Eliminar</button></td></tr>';
                if (state == "add"){ 
            ...
            error: function (data) {
                ...
                if(data.responseJSON.hasOwnProperty("valor")){
                  errHTML+="<li>"+data.responseJSON.valor+"</li>";  
                }
