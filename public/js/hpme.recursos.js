...
$(document).ready(function(){
    ...
    $('#btnAgregar').click(function(){
        $('#inputTitle').html("Agregar Recurso");
    ...
    $(document).on('click','.btn-editar',function(){
        ...
        $('#inputTitle').html("Editar Recurso");
    ...
    $("#btnGuardar").click(function (e) {      
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data); 
                var item = '<tr class="even gradeA" id="item'+data.ide_recurso+'">'
                    item+='<td>'+data.nombre+'</td>'
                    item+='<td>'+data.descripcion+'</td>';
                    item+='<td><button class="btn btn-primary btn-editar" value="'+data.ide_recurso+'"><i class="icon-pencil icon-white" ></i> Editar</button>';
                    item+='<button class="btn btn-danger" value="'+data.ide_recurso+'"><i class="icon-remove icon-white"></i> Eliminar</button></td></tr>';
                if (state == "add"){ 
